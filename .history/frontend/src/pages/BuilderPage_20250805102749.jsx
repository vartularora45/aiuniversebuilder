...
const DroppedBlock = ({ block, index, onEdit, onDelete }) => {
  ...
  return (
    <div className={`${tool?.color || 'bg-gray-700'} p-4 rounded-xl  shadow-lg backdrop-blur-sm border border-white/20 min-w-screen group relative`}>
...
const BuilderPage = () => {
  ...
  return (
    <div className="h-screen min-w-screen bg-gradient-to-br from-[#0a0a0a] via-[#1a1a2e] to-[#16213e] text-white overflow-hidden">
